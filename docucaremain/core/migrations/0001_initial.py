# Generated by Django 5.1.2 on 2024-11-27 10:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MedicalTestApplication',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('application_date', models.DateTimeField(auto_now_add=True)),
                ('payment_status', models.CharField(default='Unpaid', max_length=20)),
                ('payment_completion_date', models.DateTimeField(blank=True, null=True)),
                ('medical_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.medicaltest')),
