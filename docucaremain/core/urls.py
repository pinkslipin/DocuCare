...
urlpatterns = [
    ...
    path('billing-records/', views.billing_record_list, name='billing_record_list'),  # Billing Records
    path('billing-records/<int:record_id>/edit/', views.update_billing_record, name='update_billing_record'),  # Edit Billing Record
    path('billing-records/<int:record_id>/delete/', views.delete_billing_record_admin, name='delete_billing_record_admin'),  # Delete Billing Record
